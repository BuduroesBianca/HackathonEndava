...
public class HackathonEndavaApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // user add test
		//User user = new User(1L, "newemail@s.unibuc.ro", "newpassword", "Alin", "Petrescu");
        //insertData(user, connection);


        // user read test
        //user = readData(connection);


        // user update test
        //user.setDetails("congratulations, you have updated data!");
        //updateData(user, connection);

        // user delete test
        //deleteData(user, connection);
